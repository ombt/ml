...
def main():
    ...
    log.info("VEHICLE - Net Loaded.")
    log.info( net.layers)
    
    # Step 3.1: Prepare the input area
    log.info("Preparing input blobs Pedestrian Detection {}".format(net.inputs))
    ...
    # Step 4
    log.info("VEHICLE - Read Net  inputs {} ".format(net.inputs[input_blob].shape) )
    n, c, h, w = net.inputs[input_blob].shape
    
    log.info("VEHICLE - Loading model to the plugin")
    ...
    while cap.isOpened():
        ...
        if exec_net.requests[cur_request_id].wait(-1) == 0:
            ...
            log.info("Pedestrian - Objects in result are {}".format(res))
        ...
        person_counter_message = "Total Num of People Found: {} ".format(str(nextPedestrianID))
