...
def main():
    ...
    #Step 5: Prepare the input objects / data
    ...
    # The image array now has all images resized and transposed to the right processable format.
    
    #Step 6: Start the inference engine and infer.
    ...
    #Step 7: The output blob ( array ) will have the results in terms of probability.
