CREATE OR REPLACE PROCEDURE SVC_PHM_OWNER.PHM_ODS_DM_FAIL_IA_PROC(V_PROD_ODS_ROUTINE_SK NUMBER,
                                                                  V_RUN_DATE DATE, 
        ...
        THEN
            ...
            THEN
                ...
                BEGIN
                    ...
                    DELETE FROM  
                        SVC_PHM_ODS.PHM_ODS_DM_FAIL_IA 
                    WHERE 
            ...
            THEN
                BEGIN 
                    ...
                    SELECT 
                        MIN(A.LOADENDTIME),
                        MAX(A.LOADENDTIME) INTO V_START_DATE, V_END_DATE
                    FROM (
                        SELECT 
                            FILEID,
                            FILESTRUCTURE,
