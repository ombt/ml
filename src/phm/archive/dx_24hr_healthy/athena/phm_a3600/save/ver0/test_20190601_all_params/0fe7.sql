...
from 
    ...
    where
        '2019-06-01' <= ae.transaction_date
    and
        ae.transaction_date < '2019-06-02'
    and 
        ae.errorcode = '0FE7'
    and 
        (('SRM' != '%' and ae.a3600_nodetype = 'SRM') or
         ('SRM' = '%' and ae.a3600_nodetype like 'SRM'))
    group by 
        ae.a3600_iom_productline,
        ae.a3600_deviceid,
        ae.a3600_iom_serial,
...
and
    (('SRM' != '%' and ae2.nodetype = 'SRM')
or
    ('SRM' = '%' and ae2.nodetype like 'SRM'))
and
    ae2.errorcode = '0FE7'
and
    coalesce(ae2.sampleid, ' ') like coalesce('%', ae2.sampleid)
and
