...
select
    a36e.transaction_date,
    a36e.a3600_deviceid,
    a36e.a3600_fileversion,
    a36e.a3600_iom_productline,
    a36e.a3600_iom_serial,
    a36e.a3600_layoutinstance,
    a36e.a3600_nodeid,
    a36e.a3600_nodetype,
    a36e.a3600_productline,
    a36e.a3600_serialnumber,
    a36e.duplicate,
    a36e.errorcode,
    a36e.file_path,
    a36e.moreinfo,
    ...
    null as dummy
from
    dx.dx_a3600_error a36e
where 
    '<START_DATE>' <= a36e.transaction_date
and
    a36e.transaction_date < '<END_DATE>'
order by 
    a36e.transaction_date
)
select
    ...
    (count(ae2.errorcode) * 100 / ac.tubestoday) as error_percentage
from
    dx.dx_a3600_counter ac,
    phm_ods_a3600_errors ae2,
    (
        select 
        ae1.a3600_iom_productline,
        ae1.a3600_deviceid,
    ...
    where
        ae1.transaction_date >= '<START_DATE>'
    and 
        ae1.errorcode = '<V_ERRORCODE1>'
    and
        ae1.a3600_iom_serial is not null
    and 
        ((('<V_NODETYPE1>' != '%') and 
          (ae1.a3600_nodetype = '<V_NODETYPE1>')) or 
         (('<V_NODETYPE1>' = '%') and 
          (ae1.a3600_nodetype like '<V_NODETYPE1>')))
    group by 
        ae1.a3600_iom_productline,
        ae1.a3600_deviceid,
        ae1.a3600_iom_serial,
...
where
    upper(trim(ae2.a3600_iom_serial)) = upper(dd.a3600_iom_serial)
and 
...
and 
   ac.tubestoday <> 0
and
    ((('<V_NODETYPE1>' != '%') and (ae2.a3600_nodetype = '<V_NODETYPE1>')) or 
     (('<V_NODETYPE1>' = '%') and (ae2.a3600_nodetype like '<V_NODETYPE1>')))
AND 
    ae2.errorcode = '<V_ERRORCODE1>'
AND 
    coalesce(ae2.sampleid, '<V_SAMP_ID_CHK1>') like 
    coalesce('<V_SAMP_ID_CHK2>', ae2.sampleid)
AND 
