...
PROCEDURE PHM_GET_ALG_DETAILS (V_ALG_SK IN NUMBER, VALGNAME OUT VARCHAR2,V_PROCESS_TYPE OUT VARCHAR2,V_ROUTINE_NAME OUT VARCHAR2,
                                             V_RUN_MODE OUT VARCHAR2,V_PROD_FAMILY OUT VARCHAR2)
AS
VSQLERRORMSG  VARCHAR2(1000);
BEGIN
