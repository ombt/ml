CREATE OR REPLACE PROCEDURE SVC_PHM_OWNER.PHM_APS(V_ALG_NUM NUMBER,
                                                  V_RUN_DATE DATE,
        ...
        THEN
            ...
            LOOP
                ...
                FOR Y IN (
                    ...
                    AND 
                        ID IN ( 'normal', 'priority','tubes','1','2','3','4','5','6','7','8' )
                    AND 
                        DURATION IN ('YTD')
                    AND 
                        ...
                        LOOP
                            ...
                            BEGIN
                                ...
                                INTO 
                                    VCOUNT_NORMAL_MAX 
                                FROM 
                                    PHM_APS_COUNTERS_TEMP WHERE ID =  'normal' 
                                AND 
                                    DURATION = 'YTD' 
                                AND 
                                    DESCRIPTION = 'InputTubeCounter' 
