...
with rawdata as (
    ...
    from (
        ...
        from ( 
            ...
            and
                dpm.transaction_date < '2019-02-01'
            and 
...
select 
    rawdata.msn as modulesn,
    rawdata.flag_date,
    sum(rawdata.sum_exceed_range_threshold) as day_range_cnt,
    sum(rawdata.sum_exceed_stddev_threshold) as day_stddev_cnt
from 
    rawdata
group by
    rawdata.msn,
