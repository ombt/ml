...
class ObjectTracker(object):
    ...
    def executeModel(self, args):    
        ...
        while cap.isOpened():
            ...
            if self.exec_net.requests[self.cur_request_id].wait(-1) == 0:
                ...
                # Calc the centroids.
                #msg = self.obj_type+","+str(datetime.datetime.fromtimestamp(time.time()).isoformat())+","+str(frame_counter)+","+str(numObjects)+","+str(nextObjectID)
                #self._q.put(msg)
                # Calc the centroids.
                #log.info("ObjectTracker : Num Objects in ONE FRAME are {} length of rect is {}, MSG {}".format(numObjects, len(rects), msg))
    ...
    def executeModelThreaded(self, args):    
        ...
        # Step 5: Start the video stream.
        labels_map = None
        log.info("ObjectTracker : THREADED frames from File...")
        self.cur_request_id = 0
        render_time = 0
            ...
            if self.exec_net.requests[self.cur_request_id].wait(-1) == 0:
                ...
                if len(objects) == 0:
                    ...
                    if len(inputCentroids) > 0: 
                        ...
                        try:
                            ...
                            log.info("ObjectTracker : KeyError - 1 - ID does not exist {} - ".format(str(e)))
                ...
                try:
                    ...
                    # object on the output frame                    
                        ...
                        log.info("ObjectTracker : KeyError - 2 -  ID does not exist{} - ".format(str(e)))
