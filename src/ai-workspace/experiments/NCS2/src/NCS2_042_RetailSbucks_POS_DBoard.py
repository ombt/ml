...
mappingfile = open('/root/ai-workspace/experiments/NCS2/data/instakart/s1_products.csv','r')
...
csvfile = open('/root/ai-workspace/experiments/NCS2/data/instakart/order_products__prior.csv','r')
